...
export default function ThreadPage({
  ...
  useEffect(() => {
    if (projectName) {
      document.title = `${projectName} | AutoBro`;
      ...
      if (metaDescription) {
        metaDescription.setAttribute(
          'content',
          `${projectName} - Interactive agent conversation powered by AutoBro`,
        );
      }

      const ogTitle = document.querySelector('meta[property="og:title"]');
      if (ogTitle) {
        ogTitle.setAttribute('content', `${projectName} | AutoBro`);
      }
        ...
        <div
          ...
          <div className={cn(
            ...
            <ChatInput
              ...
              placeholder={`Ask ${agent ? agent.name : 'AutoBro'} anything...`}
              loading={isSending}
