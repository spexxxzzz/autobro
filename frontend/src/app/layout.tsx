...
export const metadata: Metadata = {
  ...
  description:
    'Suna is a fully open source AI assistant that helps you accomplish real-world tasks with ease. Through natural conversation,  becomes your digital companion for research, data analysis, and everyday challenges.',
  keywords: [
    'AI',
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body
        className={`${inter.variable} ${robotoMono.variable} antialiased font-sans bg-background`}
      >
        <noscript>
          <iframe
