...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | AutoBro',
    description: 'Replay this Agent conversation on AutoBro',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Autobro';
    const description =
      projectData.description ||
      'Replay this Agent conversation on AutoBro';
